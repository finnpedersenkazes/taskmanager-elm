...
From https://github.com/halfzebra/create-elm-app/blob/master/template/README.md
...
- [Elm App](#elm-app)
  ...
  - [Deployment](#deployment)
    ...
    - [GitHub Pages](#github-pages)
      ...
      - [Step 2: Build the static site](#step-2-build-the-static-site-1)
      - [Step 3: Deploy the site by running `gh-pages -d build`](#step-3-deploy-the-site-by-running-gh-pages--d-build-1)
